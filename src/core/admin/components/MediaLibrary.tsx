                ...
                <div className="px-6 py-3 border-b border-gray-100 flex flex-col sm:flex-row items-start sm:items-center gap-3">
                    <div className="flex bg-gray-100 rounded-lg p-1">
                        <button
                            ...
                            className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${activeTab === "library"
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                                {filteredImages.map((img) => (
                                    <div
                                        ...
                                        className={`group relative aspect-square rounded-xl overflow-hidden cursor-pointer border-2 transition-all hover:shadow-lg ${selectedUrl === img.url
                                    ...
                                    >
                                        ...
                                        {/* Hover overlay */}
                                        <div className={`absolute inset-0 transition-opacity ${selectedUrl === img.url
                                                ? "bg-emerald-500/10"
                            ...
                            <div className="space-y-1">
                                {filteredImages.map((img) => (
                                    <div
                                        key={img.name}
                                        onClick={() => setSelectedUrl(selectedUrl === img.url ? null : img.url)}
                                        className={`flex items-center gap-3 p-3 rounded-xl cursor-pointer transition-all ${selectedUrl === img.url
                    ...
                    <div className="px-6 py-4 border-t border-gray-100 flex items-center justify-between bg-gray-50/50">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <button
                                ...
                                className={`px-5 py-2 rounded-lg text-sm font-medium transition-all flex items-center gap-2 ${selectedUrl
